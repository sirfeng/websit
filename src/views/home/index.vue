<template>
  <header class="header-view">
    ...
    <div>
      <el-icon
        ...
        color="#ffffff"
        style="margin: 0 10px"
        @click="handleOpen('https://discord.gg/QRu7NMkd5E')"
      >
        <Discord />
      </el-icon>
      <el-icon
        size="32"
        color="#ffffff"
        @click="handleOpen('https://github.com/GptPluginHub/websit')"
      >
        <Github />
      </el-icon>
    </div>
    ...
    <el-row justify="center">
      ...
      <el-col :span="10" :xs="24">
        <div style="text-align: center; margin-bottom: 40px">
          ...
          <div style="color: #324a6d; line-height: 1.5; margin-top: 20px">
            Welcome to GPH (ChatGPT Plugin Hub), the ultimate marketplace for
            ChatGPT plugins! Share your plugin usage experiences and rate them
            to help others. Discover amazing plugins and enhance your ChatGPT
            experience today!
          </div>
        </div>
      </el-col>
      ...
      <el-col :span="12" :xs="24">
        <el-form @submit.prevent>
          <el-form-item>
            <el-input
              size="large"
              v-model="data.formData.fuzzyName"
              clearable
              @clear="handleSearch"
  ...
  <div class="content-view">
    <el-row style="margin-bottom: 10px">
      <el-col :span="12">
        <el-select
          v-model="data.formData.sortByFieldName"
          @change="handleCheckboxChange"
        >
          <el-option
            v-for="item in data.sortBy"
            :key="item.value"
            :label="item.label"
            :value="item.value"
          />
    ...
    <el-row :gutter="20" v-if="data.page.total != 0">
      <el-col>
        <el-pagination
          ...
          :page-size="data.formData.pageSize"
  ...
  <el-drawer
    :size="data.WDrawer"
    v-model="data.drawerData.visibleDrawer"
    direction="rtl"
  ...
  >
    ...
    <template #default>
      <div>
        <el-form
          :model="data.drawerData.formData"
          @submit.prevent
          label-width="100"
        >
          ...
          <el-form-item label="comments:">
            <el-input
              v-model="data.drawerData.formData.comments"
              placeholder="Please enter a comments"
              clearable
            >
            </el-input>
          </el-form-item>
...
import { v1alpha1Plugins, pluginScore } from "@/plugins/modules/home/index.js";
export default {
  components: {
    Edit,
    Heat,
  ...
  setup() {
    ...
    const handleCardClick = (item) => {
      window.open(
        `https://a60.ronfu.top/api/hub.io/v1alpha1/openapi?openapi_url=${item.apiUrl}`
      );
    };
    const handleTK = (item) => {
